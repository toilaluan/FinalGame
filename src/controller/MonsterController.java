...
public class MonsterController extends EntityController{
    ...
    private void setDefaultValue(){
        monster.worldX = gp.tileSize * 28;
        monster.worldY = gp.tileSize * 10;
    ...
    public void checkBom(){
        for (int i = 0; i < gp.dameOBJ.size(); i++){
            int dx = gp.dameOBJ.get(i).worldX - monster.worldX;
            int dy = gp.dameOBJ.get(i).worldY - monster.worldY;
            double distance = Math.sqrt(dx*dx + dy*dy);
            if (distance < gp.tileSize){
                monster.life -= gp.player.attack*2;
                gp.dameOBJ.remove(i);
            }
        }
    }
    ...
    public void update() {
        ...
        if (gp.monster1.life <= 0){
            ...
            gp.monster1.worldY = 0;
            gp.monster1.worldX = 0;
        }
